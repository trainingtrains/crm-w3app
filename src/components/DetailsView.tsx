...
const DetailsView = ({ config, data, actionLabel, onActionClick, negativeLabel, onhandleNegativeClick }: DetailsViewProps) => {
    ...
    return (
        <>
            <ActionContainer>
                ...
                {actionLabel && <SearchButton variant="outlined" onClick={onActionClick}>
                    {actionLabel}
                </SearchButton>}
            </ActionContainer>
            <Card elevation={2}>
